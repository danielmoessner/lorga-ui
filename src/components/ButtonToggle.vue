  ...
  <SwitchGroup as="div" class="flex items-center">
    <Switch
      ...
      :class="[
        ...
        'relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-formcolor focus:ring-offset-2',
      ]"
    >
      <span
        aria-hidden="true"
